...
The aim of this script is to make PRISMA flowcharts for different clinical scenarios and outcomes. The number of patients in each group is copied from a secure server for sensitive data (not available here). Start by loading the library.
...
Next the flowchart for **GS1 and GS2 (HPV+ and HPV- signatures) and overall survival**. These use the same data. 
