...
```{r GS1 GS2 GS3 OS}
flow_exclusions(
    incl_counts = c(1736, 1286, 1249, 1224, 1107),
    total_label = "Total Screened",
...
The flowchart for **GS1, GS2 and GS3 and disease-free survival** is very similar. Note that SCANDARE is also excluded at the outcome stage due to DFS information being very low quality. These also use the same subset of data, but GS3 has different variable encoding. 

```{r GS1 GS2 GS3 DFS}
flow_exclusions(
    incl_counts = c(1736, 1286, 1249, 1224, 912),
    total_label = "Total Screened",
    incl_labels = c("Gene expression available", "Curative setting", "Early disease or locoregionally advanced disease", "Outcome available"),
    excl_labels = c("Missing gene expression", "Recurrence/Metastatic setting", "Metastatic disease", "Missing outcome"),
    percent_of_total = TRUE, labelloc="t", label="test"
