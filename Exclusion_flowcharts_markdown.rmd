...
flow_exclusions(
    ...
    excl_labels = c("Recurrence/Metastatic setting", "Metastatic disease / missing TNM stage", "Missing outcome"),
...
flow_exclusions(
    ...
    excl_labels = c("Missing gene expression", "Recurrence/Metastatic setting", "Metastatic disease / missing TNM stage", "Missing outcome"),
    percent_of_total = TRUE
  )
